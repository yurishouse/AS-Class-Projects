...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void setupSharedPreferences() {
        ...
        loadbgcolorFromPreferences(sharedPreferences);

        // Register the listener
        sharedPreferences.registerOnSharedPreferenceChangeListener(this);
    }

    private void loadbgcolorFromPreferences(SharedPreferences sharedPreferences) {
        mVisualizerView.setBackgroundColor(sharedPreferences.getString(getString(R.string.pref_bg_color_key),
