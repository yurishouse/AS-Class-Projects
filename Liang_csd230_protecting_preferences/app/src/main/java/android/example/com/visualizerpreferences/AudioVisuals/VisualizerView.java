...
public class VisualizerView extends View {
    ...
    public void setBackgroundColor(String newBackgroundColorKey) {


        if (newBackgroundColorKey.equals(getContext().getString(R.string.pref_color_blue_value))) {
            backgroundColor = ContextCompat.getColor(getContext(), R.color.backgroundBlue);
        } else if (newBackgroundColorKey.equals(getContext().getString(R.string.pref_color_green_value))) {
            backgroundColor = ContextCompat.getColor(getContext(), R.color.backgroundGreen);
        } else {
            backgroundColor = ContextCompat.getColor(getContext(), R.color.backgroundRed);
        }
